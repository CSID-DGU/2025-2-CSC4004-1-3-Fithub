            ...
            if nid not in existing_ids:
                ...
                if docstring:
                    ...
                    try:
                        ...
                        # This hits the configured LLM API (HF/OpenAI)
                        api_res = summarizer.summarize_code(pseudo_code, nid)
                        summary_text = api_res.get('text', f"Function {func_name}")

                        summary_details = {
                            "logic": summary_text,
                            "intent": "Generated by External AI API.",
                            "structure": f"Arguments: {', '.join(args) if args else 'None'}"
                        }
