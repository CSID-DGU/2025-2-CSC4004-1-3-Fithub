...
import { createProject, getProjectById, addRepoToProject, addProjectMember, getProjectMembers,removeProjectMember,getUserRoles,updateProjectMemberRole } from "../controller/projectController";
...
router.get("/roles",requireAuth,getUserRoles); //역할 조회
router.patch("/:projectId/members/:memberId/role", requireAuth, requireProjectOwner, updateProjectMemberRole); //멤버 역할 추가
